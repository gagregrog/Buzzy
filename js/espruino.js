// example for playing a song on an espruino device
...
var tune = heman;
function freq(f) {
  if (!f) digitalWrite(BUZZER,0);
  else analogWrite(BUZZER, 0.5, { freq: f } );
}
var pitches = { "a": 220, "a#": 233.08, "b": 246.94, "c": 261.63,
...
setWatch(handleWatch, D0, { repeat:true, edge:'falling', debounce : 49.99923706054 });
